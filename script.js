...
(() => {
    ...
    var $ = (e, t, r) => (r = e != null ? q_(M_(e)) : {}, bs(t || !e || !e.__esModule ? zr(r, "default", {
            value: e,
            enumerable: !0
        }) : r, e)),
        Ue = e => bs(zr({}, "__esModule", {
            value: !0
        }), e);
    var _i = c(() => {
        "use strict";
        window.tram = function(e) {
            ...
            function i(l, h, E) {
                return "#" + (1 << 24 | l << 16 | h << 8 | E).toString(16).slice(1)
            }
            ...
            function u(l, h, E) {
                ...
                var T = E;
                return C_.test(l) || !Is.test(l) ? T = parseInt(l, 10) : Is.test(l) && (T = 1e3 * parseFloat(l)), 0 > T && (T = 0), T === T ? T : E
            }
            ...
            var p = function(l, h, E) {
                    ...
                    function V(X, te) {
                        ...
                        return Be.constructor = q, q.mixin = function(he) {
                            ...
                            if (K = {}, C(he) ? K = he.call(q, Be, ae, q, X) : T(he) && (K = he), T(K))
                ...
                d = {
                    ease: ["ease", function(l, h, E, T) {
                        var C = (l /= T) * l,
                            A = C * l;
                        return h + E * (-2.75 * A * C + 11 * C * C + -15.5 * A + 8 * C + .25 * l)
                    }],
                    "ease-in": ["ease-in", function(l, h, E, T) {
                        var C = (l /= T) * l,
                            A = C * l;
                        return h + E * (-1 * A * C + 3 * C * C + -3 * A + 2 * C)
                    }],
                    "ease-out": ["ease-out", function(l, h, E, T) {
                        var C = (l /= T) * l,
                            A = C * l;
                        return h + E * (.3 * A * C + -1.6 * C * C + 2.2 * A + -1.8 * C + 1.9 * l)
                    }],
                    "ease-in-out": ["ease-in-out", function(l, h, E, T) {
                        var C = (l /= T) * l,
                            A = C * l;
                        return h + E * (2 * A * C + -5 * C * C + 2 * A + 2 * C)
                    }],
                    linear: ["linear", function(l, h, E, T) {
                        return E * l / T + h
                    }],
                    "ease-in-quad": ["cubic-bezier(0.550, 0.085, 0.680, 0.530)", function(l, h, E, T) {
                        return E * (l /= T) * l + h
                    }],
                    "ease-out-quad": ["cubic-bezier(0.250, 0.460, 0.450, 0.940)", function(l, h, E, T) {
                        return -E * (l /= T) * (l - 2) + h
                    }],
                    "ease-in-out-quad": ["cubic-bezier(0.455, 0.030, 0.515, 0.955)", function(l, h, E, T) {
                        return (l /= T / 2) < 1 ? E / 2 * l * l + h : -E / 2 * (--l * (l - 2) - 1) + h
                    }],
                    "ease-in-cubic": ["cubic-bezier(0.550, 0.055, 0.675, 0.190)", function(l, h, E, T) {
                        return E * (l /= T) * l * l + h
                    }],
                    "ease-out-cubic": ["cubic-bezier(0.215, 0.610, 0.355, 1)", function(l, h, E, T) {
                        return E * ((l = l / T - 1) * l * l + 1) + h
                    }],
                    "ease-in-out-cubic": ["cubic-bezier(0.645, 0.045, 0.355, 1)", function(l, h, E, T) {
                        return (l /= T / 2) < 1 ? E / 2 * l * l * l + h : E / 2 * ((l -= 2) * l * l + 2) + h
                    }],
                    "ease-in-quart": ["cubic-bezier(0.895, 0.030, 0.685, 0.220)", function(l, h, E, T) {
                        return E * (l /= T) * l * l * l + h
                    }],
                    "ease-out-quart": ["cubic-bezier(0.165, 0.840, 0.440, 1)", function(l, h, E, T) {
                        return -E * ((l = l / T - 1) * l * l * l - 1) + h
                    }],
                    "ease-in-out-quart": ["cubic-bezier(0.770, 0, 0.175, 1)", function(l, h, E, T) {
                        return (l /= T / 2) < 1 ? E / 2 * l * l * l * l + h : -E / 2 * ((l -= 2) * l * l * l - 2) + h
                    }],
                    "ease-in-quint": ["cubic-bezier(0.755, 0.050, 0.855, 0.060)", function(l, h, E, T) {
                        return E * (l /= T) * l * l * l * l + h
                    }],
                    "ease-out-quint": ["cubic-bezier(0.230, 1, 0.320, 1)", function(l, h, E, T) {
                        return E * ((l = l / T - 1) * l * l * l * l + 1) + h
                    }],
                    "ease-in-out-quint": ["cubic-bezier(0.860, 0, 0.070, 1)", function(l, h, E, T) {
                        return (l /= T / 2) < 1 ? E / 2 * l * l * l * l * l + h : E / 2 * ((l -= 2) * l * l * l * l + 2) + h
                    }],
                    "ease-in-sine": ["cubic-bezier(0.470, 0, 0.745, 0.715)", function(l, h, E, T) {
                        return -E * Math.cos(l / T * (Math.PI / 2)) + E + h
                    }],
                    "ease-out-sine": ["cubic-bezier(0.390, 0.575, 0.565, 1)", function(l, h, E, T) {
                        return E * Math.sin(l / T * (Math.PI / 2)) + h
                    }],
                    "ease-in-out-sine": ["cubic-bezier(0.445, 0.050, 0.550, 0.950)", function(l, h, E, T) {
                        return -E / 2 * (Math.cos(Math.PI * l / T) - 1) + h
                    }],
                    "ease-in-expo": ["cubic-bezier(0.950, 0.050, 0.795, 0.035)", function(l, h, E, T) {
                        return l === 0 ? h : E * Math.pow(2, 10 * (l / T - 1)) + h
                    }],
                    "ease-out-expo": ["cubic-bezier(0.190, 1, 0.220, 1)", function(l, h, E, T) {
                        return l === T ? h + E : E * (-Math.pow(2, -10 * l / T) + 1) + h
                    }],
                    "ease-in-out-expo": ["cubic-bezier(1, 0, 0, 1)", function(l, h, E, T) {
                        return l === 0 ? h : l === T ? h + E : (l /= T / 2) < 1 ? E / 2 * Math.pow(2, 10 * (l - 1)) + h : E / 2 * (-Math.pow(2, -10 * --l) + 2) + h
                    }],
                    "ease-in-circ": ["cubic-bezier(0.600, 0.040, 0.980, 0.335)", function(l, h, E, T) {
                        return -E * (Math.sqrt(1 - (l /= T) * l) - 1) + h
                    }],
                    "ease-out-circ": ["cubic-bezier(0.075, 0.820, 0.165, 1)", function(l, h, E, T) {
                        return E * Math.sqrt(1 - (l = l / T - 1) * l) + h
                    }],
                    "ease-in-out-circ": ["cubic-bezier(0.785, 0.135, 0.150, 0.860)", function(l, h, E, T) {
                        return (l /= T / 2) < 1 ? -E / 2 * (Math.sqrt(1 - l * l) - 1) + h : E / 2 * (Math.sqrt(1 - (l -= 2) * l) + 1) + h
                    }],
                    "ease-in-back": ["cubic-bezier(0.600, -0.280, 0.735, 0.045)", function(l, h, E, T, C) {
                        return C === void 0 && (C = 1.70158), E * (l /= T) * l * ((C + 1) * l - C) + h
                    }],
                    "ease-out-back": ["cubic-bezier(0.175, 0.885, 0.320, 1.275)", function(l, h, E, T, C) {
                        return C === void 0 && (C = 1.70158), E * ((l = l / T - 1) * l * ((C + 1) * l + C) + 1) + h
                    }],
                    "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(l, h, E, T, C) {
                        return C === void 0 && (C = 1.70158), (l /= T / 2) < 1 ? E / 2 * l * l * (((C *= 1.525) + 1) * l - C) + h : E / 2 * ((l -= 2) * l * (((C *= 1.525) + 1) * l + C) + 2) + h
                    }]
                },
                m = {
                ...
                D = function(l) {
                    ...
                    for (h = 0; h < _.length; h++)
                        if (E = _[h] + T, E in L.style) return {
                            dom: E,
                            css: N[h] + l
                        }
                },
            ...
            var J = t.frame = function() {
                ...
                it = p(function(l) {
                    ...
                    function Be(B, Y, ie) {
                        var Q, ve, Ne, Te, jr = Y !== he,
                            se = {};
                        for (Q in B) Ne = B[Q], Q in ot ? (se.transform || (se.transform = {}), se.transform[Q] = Ne) : (S.test(Q) && (Q = r(Q)), Q in mi ? se[Q] = Ne : (Te || (Te = {}), Te[Q] = Ne));
                        for (Q in se) {
                    ...
                    }, Re("add", h), Re("start", E), Re("wait", T), Re("then", C), Re("next", A), Re("stop", V), Re("set", X), Re("show", te), Re("hide", q), Re("redraw", z), Re("destroy", K)
                }),
                ge = p(it, function(l) {
                    function h(E, T) {
                ...
                j = p(function(l) {
                    ...
                    l.init = function(A, V, X, te) {
                        ...
                        A = this.convert(A, this.type), this.auto && (V == "auto" && (V = this.convert(this.get(), this.type)), A == "auto" && (A = h.call(this))), this.tween = new or({
                            from: V,
                            to: A,
                ...
                kr = p(j, function(l, h) {
                    function E(T, C) {
                        var A, V, X, te, q;
                        for (A in T) te = ot[A], X = te[0], V = te[1] || A, q = this.convert(T[A], X), C.call(this, V, q, X)
                    }
                    l.init = function() {
                        h.init.apply(this, arguments), this.current || (this.current = {}, ot.perspective && _e.perspective && (this.current.perspective = _e.perspective, At(this.el, this.name, this.style(this.current)), this.redraw()))
                    }, l.set = function(T) {
                        ...
                        var C, A = {};
                        return E.call(this, T, function(V, X, te) {
                            A[V] = X, this.current[V] === void 0 && (C = 0, ~V.indexOf("scale") && (C = 1), this.current[V] = this.convert(C, te))
                        }), A
                    }
                }),
                or = p(function(l) {
                ...
                ms = p(or, function(l, h) {
                    l.init = function(E) {
                        ...
                        var T, C;
                        for (T in E.values) C = E.values[T], this.current[T] !== C && this.tweens.push(new or({
                            name: T,
                            from: this.current[T],
                            to: C,
                            duration: E.duration,
                        ...
                        var T, C, A = this.tweens.length,
                            V = !1;
                        for (T = A; T--;) C = this.tweens[T], C.context && (C.render(E), this.current[C.name] = C.value, V = !0);
            ...
            var At = e.style,
                ...
                ot = {};
            P.transform && (mi.transform = [kr], ot = {
                x: [x, "translateX"],
                y: [x, "translateY"],
                rotate: [F],
                rotateX: [F],
                ...
                skewX: [F],
                skewY: [F]
            }), P.transform && P.backface && (ot.z = [x, "translateZ"], ot.rotateZ = [F], ot.scaleZ = [I], ot.perspective = [R]);
            var C_ = /ms/,
                Is = /s|\./;
            return e.tram = t
        }(window.jQuery)
    ...
    var As = c((TB, Os) => {
        ...
        Os.exports = function() {
            ...
            e.map = e.collect = function(_, N, D) {
                var P = [];
                return _ == null ? P : p && _.map === p ? _.map(N, D) : (x(_, function(W, H, J) {
                    P.push(N.call(D, W, H, J))
                }), P)
            }, e.find = e.detect = function(_, N, D) {
                var P;
                return F(_, function(W, H, J) {
                    if (N.call(D, W, H, J)) return P = W, !0
                }), P
            }, e.filter = e.select = function(_, N, D) {
                var P = [];
                return _ == null ? P : O && _.filter === O ? _.filter(N, D) : (x(_, function(W, H, J) {
            ...
            var F = e.some = e.any = function(_, N, D) {
                N || (N = e.identity);
                var P = !1;
                return _ == null ? P : b && _.some === b ? _.some(N, D) : (x(_, function(W, H, J) {
            ...
            e.contains = e.include = function(_, N) {
                ...
                var N, D, P;
                return function() {
                    N || (N = !0, D = arguments, P = this, V_.frame(function() {
                        N = !1, _.apply(P, D)
                    }))
                }
            }, e.debounce = function(_, N, D) {
                var P, W, H, J, xe, it = function() {
                    var ge = e.now() - J;
                    ge < N ? P = setTimeout(it, N - ge) : (P = null, D || (xe = _.apply(H, W), H = W = null))
                };
                return function() {
                    H = this, W = arguments, J = e.now();
                    var ge = D && !P;
                    return P || (P = setTimeout(it, N)), ge && (xe = _.apply(H, W), H = W = null), xe
                }
            ...
            return e.template = function(_, N, D) {
                ...
                var P = RegExp([(N.escape || M).source, (N.interpolate || M).source, (N.evaluate || M).source].join("|") + "|$", "g"),
                    W = 0,
                    H = "__p+='";
...
` + H + "}", it
    ...
    var $e = c((IB, qs) => {
        ...
        function ws(e) {
            Z.env() && (Xe(e.design) && qe.on("__wf_design", e.design), Xe(e.preview) && qe.on("__wf_preview", e.preview)), Xe(e.destroy) && qe.on("__wf_destroy", e.destroy), e.ready && Xe(e.ready) && U_(e)
        }
        ...
        function Cs(e) {
            Xe(e.design) && qe.off("__wf_design", e.design), Xe(e.preview) && qe.off("__wf_preview", e.preview), Xe(e.destroy) && qe.off("__wf_destroy", e.destroy), e.ready && Xe(e.ready) && X_(e)
        }
        ...
        var Kr = navigator.userAgent.toLowerCase(),
            Rs = Z.env.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch,
            H_ = Z.env.chrome = /chrome/.test(Kr) && /Google/.test(navigator.vendor) && parseInt(Kr.match(/chrome\/(\d+)\./)[1], 10),
            k_ = Z.env.ios = /(ipod|iphone|ipad)/.test(Kr);
        Z.env.safari = /safari/.test(Kr) && !H_ && !k_;
        var Ti;
        Rs && B_.on("touchstart mousedown", function(e) {
            Ti = e.target
        });
        Z.validClick = Rs ? function(e) {
        ...
        function Ls() {
            gt && (gt.reject(), qe.off("load", gt.resolve)), gt = new at.Deferred, qe.on("load", gt.resolve)
        }
        Z.destroy = function(e) {
            e = e || {}, bi = !0, qe.triggerHandler("__wf_destroy"), e.domready != null && (Yr = e.domready), Le.each(St, Cs), Z.resize.off(), Z.scroll.off(), Z.redraw.off(), xt = [], Ii = [], gt.state() === "pending" && Ls()
        };
        at(Z.ready);
        Ls();
    ...
    var Ms = c((bB, Fs) => {
        "use strict";
        var Ps = $e();
        Ps.define("brand", Fs.exports = function(e) {
            var t = {},
                r = document,
                n = e("html"),
                i = e("body"),
            ...
            t.ready = function() {
                ...
                /\.webflow\.io$/i.test(O) && a.hostname !== O && (m = !0), m && !s && (f = f || p(), d(), setTimeout(d, 500), e(r).off(u, g).on(u, g))
            };
    ...
    var Gs = c((OB, Ds) => {
        "use strict";
        var Ai = $e();
        Ai.define("edit", Ds.exports = function(e, t, r) {
            if (r = r || {}, (Ai.env("test") || Ai.env("frame")) && !r.fixture && !z_()) return {
                exit: 1
            };
            var n = {},
                i = e(window),
            ...
            function d() {
                u = !0, window.WebflowEditor = !0, i.off(s, p), S(function(w) {
                    e.ajax({
    ...
    var Bs = c((AB, Vs) => {
        "use strict";
        var K_ = $e();
        K_.define("focus-visible", Vs.exports = function() {
            function e(r) {
                var n = !0,
                    i = !1,
                    o = null,
                ...
                function u(I) {
                    var w = I.type,
                        R = I.tagName;
                    return !!(R === "INPUT" && a[w] && !I.readOnly || R === "TEXTAREA" && !I.readOnly || I.isContentEditable)
                }
                ...
                document.addEventListener("keydown", p, !0), document.addEventListener("mousedown", d, !0), document.addEventListener("pointerdown", d, !0), document.addEventListener("touchstart", d, !0), document.addEventListener("visibilitychange", y, !0), b(), r.addEventListener("focus", m, !0), r.addEventListener("blur", O, !0)
            }
    ...
    var js = c((xB, Ws) => {
        ...
        var Si = window.jQuery,
            ...
            Qr = {
                ...
                intro: function(e, t) {
                    t.__wf_intro || (t.__wf_intro = !0, Si(t).triggerHandler(He.types.INTRO))
                },
                outro: function(e, t) {
                    t.__wf_intro && (t.__wf_intro = null, Si(t).triggerHandler(He.types.OUTRO))
                }
            };
        He.triggers = {};
        He.types = {
    ...
    var Jr = c((RB, sr) => {
        ...
        sr.exports = Z_, sr.exports.__esModule = !0, sr.exports.default = sr.exports
    });
    var Js = c((NB, ur) => {
        function J_(e) {
        ...
        ur.exports = J_, ur.exports.__esModule = !0, ur.exports.default = ur.exports
    });
    var ne = c((LB, eu) => {
        var en = function(e) {
            return e && e.Math == Math && e
        };
        eu.exports = en(typeof globalThis == "object" && globalThis) || en(typeof window == "object" && window) || en(typeof self == "object" && self) || en(typeof global == "object" && global) || function() {
            return this
    ...
    var tn = c((FB, nu) => {
        ...
        nu.exports = cr.bind ? cr.bind(cr) : function() {
    ...
    var Nu = c((KB, Ru) => {
        var Cu = ne(),
            ...
            wu = xu && xu.v8,
            Fe, rn;
        wu && (Fe = wu.split("."), rn = Fe[0] > 0 && Fe[0] < 4 ? 1 : +(Fe[0] + Fe[1]));
        !rn && Fi && (Fe = Fi.match(/Edge\/(\d+)/), (!Fe || Fe[1] >= 74) && (Fe = Fi.match(/Chrome\/(\d+)/), Fe && (rn = +Fe[1])));
        Ru.exports = rn
    });
    var Mi = c((YB, qu) => {
        var Lu = Nu(),
            mT = wt();
        qu.exports = !!Object.getOwnPropertySymbols && !mT(function() {
            var e = Symbol();
    ...
    var ki = c((cU, ac) => {
        ...
        ac.exports = function(e) {
            if (!rc(Rt, e) || !(nc || typeof Rt[e] == "string")) {
                var t = "Symbol." + e;
                nc && rc(vt, e) ? Rt[e] = vt[e] : oc && ic ? Rt[e] = ic(t) : Rt[e] = eI(t)
            }
            return Rt[e]
        }
    });
    var lc = c((lU, cc) => {
        ...
        cc.exports = function(e, t) {
            ...
            var r = nI(e, sI),
                n;
            if (r) {
                if (t === void 0 && (t = "default"), n = rI(r, e, t), !sc(n) || uc(n)) return n;
    ...
    var Yi = c(vc => {
        ...
        vc.f = hI ? hc : function(t, r) {
            if (t = mI(t), r = _I(r), II) try {
                return hc(t, r)
            } catch {}
    ...
    var pr = c(Tc => {
        ...
        Tc.f = xI ? _c : function(t, r, n) {
            if (mc(t), r = CI(r), mc(n), wI) try {
                return _c(t, r, n)
            } catch {}
    ...
    var Qi = c((yU, bc) => {
        ...
        FI($i.inspectSource) || ($i.inspectSource = function(e) {
            return MI(e)
        });
    ...
    var Fc = c((IU, Pc) => {
        var XI = Sc(),
            ...
            YI = function(e) {
                return function(t) {
                    var r;
                    if (!HI(t) || (r = gr(t)).type !== e) throw no("Incompatible receiver, " + e + " required");
                    return r
                }
            };
        XI || to.state ? (ut = to.state || (to.state = new zI), Nc = Ji(ut.get), ro = Ji(ut.has), Lc = Ji(ut.set), un = function(e, t) {
            ...
            return ro(ut, e)
        }) : (Et = WI("state"), jI[Et] = !0, un = function(e, t) {
    ...
    var Hc = c((OU, Xc) => {
        ...
        (Xc.exports = function(e, t, r, n) {
            var i = n ? !!n.unsafe : !1,
                ...
                u;
            if (Vc(r) && (String(s).slice(0, 7) === "Symbol(" && (s = "[" + String(s).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!tb(r, "name") || ib && r.name !== s) && Bc(r, "name", s), u = ab(r), u.source || (u.source = sb.join(typeof s == "string" ? s : ""))), e === eb) {
                o ? e[t] = r : rb(t, r);
                return
    ...
    var sl = c((PU, al) => {
        var Sb = fr(),
            ...
            Rb = dr(),
            Nb = xb([].concat);
        al.exports = Sb("Reflect", "ownKeys") || function(t) {
            var r = wb.f(Rb(t)),
                n = Cb.f;
            return n ? Nb(r, n(t)) : r
        }
    ...
    var pl = c((DU, dl) => {
        ...
        dl.exports = function(e, t) {
            var r = e.target,
                ...
                i = e.stat,
                o, a, s, u, f, g;
            if (n ? a = lo : i ? a = lo[r] || jb(r, {}) : a = (lo[r] || {}).prototype, a)
                for (s in t) {
                    if (f = t[s], e.noTargetGet ? (g = Hb(a, s), u = g && g.value) : u = a[s], o = Kb(n ? s : r + (i ? "." : "#") + s, e.forced), !o && u !== void 0) {
    ...
    var El = c((VU, vl) => {
        var Qb = ht(),
            ...
            e0 = lr(),
            t0 = hl();
        vl.exports = Qb ? Object.defineProperties : function(t, r) {
            Jb(t);
            for (var n = e0(r), i = t0(r), o = i.length, a = 0, s; o > a;) Zb.f(t, s = i[a++], n[s]);
            return t
        }
    });
    var ml = c((BU, yl) => {
    ...
    var xl = c((UU, Sl) => {
        var n0 = dr(),
            ...
            fn, dn = function() {
                ...
                dn = typeof document < "u" ? document.domain && fn ? bl(fn) : c0() : bl(fn);
        ...
        Sl.exports = Object.create || function(t, r) {
            var n;
            return t !== null ? (fo[po] = n0(t), n = new fo, fo[po] = null, n[Ol] = t) : n = dn(), r === void 0 ? n : i0(n, r)
        }
    });
    var Cl = c((XU, wl) => {
        var l0 = ki(),
    ...
    var ct = c((eX, $l) => {
        ...
        function D0(e) {
            return e == null ? e === void 0 ? M0 : F0 : Yl && Yl in Object(e) ? q0(e) : P0(e)
        }
        $l.exports = D0
    });
    var yo = c((tX, Ql) => {
    ...
    var nf = c((bo, Io) => {
        ...
        var Lt;
        typeof self < "u" ? Lt = self : typeof window < "u" ? Lt = window : typeof global < "u" ? Lt = global : typeof Io < "u" ? Lt = Io : Lt = Function("return this")();
    ...
    var Oo = c(Er => {
        ...
        function uf(e, t, r) {
            ...
            function d(y) {
                if (!(0, nO.default)(y)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
            ...
            return function(n) {
                return function(i, o, a) {
                    ...
                    return f = t.map(function(p) {
                        return p(g)
                    }), u = hO.default.apply(void 0, f)(s.dispatch), pO({}, s, {
                        dispatch: u
                    })
                }
            }
    ...
    var De, qo, We, CO, RO, pn, NO, Po = re(() => {
        "use strict";
        De = {
    ...
    var PO, FO, MO, DO, GO, VO, BO, Fo, vf = re(() => {
        "use strict";
        gn();
        ({
            TRANSFORM_MOVE: PO,
    ...
    var UO, XO, HO, kO, WO, jO, zO, KO, YO, $O, QO, ZO, JO, eA, tA, rA, nA, iA, oA, aA, Ef = re(() => {
        "use strict";
    ...
    var Bf, pS, gS, hS, vS, ES, Vf, Uf, Xf = re(() => {
        "use strict";
        Oe();
        Bf = $(Pt()), {
    ...
    var Ee, yS, mS, _S, TS, IS, bS, OS, AS, SS, xS, Hf, wS, kf, Wf = re(() => {
        "use strict";
        Oe();
        Ee = $(Pt()), {
    ...
    var Id = c((QX, Td) => {
        var px = Do(),
            ...
            bx = RegExp("^" + Tx.call(Ix).replace(Ex, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
    ...
    var np = c((vH, rp) => {
        ...
        function Iw(e, t) {
            ...
            if (r instanceof yw) {
                var n = r.__data__;
                if (!mw || n.length < Tw - 1) return n.push([e, t]), this.size = ++r.size, this;
    ...
    var Wo = c((qH, Pp) => {
        var yC = Np(),
            ...
            IC = qp ? function(e) {
                return e == null ? [] : (e = Object(e), yC(qp(e), function(t) {
                    return TC.call(e, t)
                }))
            } : mC;
        Pp.exports = IC
    ...
    var $p = c((BH, Yp) => {
        var HC = ct(),
            ...
            ee = {};
        ee[sR] = ee[uR] = ee[cR] = ee[lR] = ee[fR] = ee[dR] = ee[pR] = ee[gR] = ee[hR] = !0;
        ee[jC] = ee[zC] = ee[oR] = ee[KC] = ee[aR] = ee[YC] = ee[$C] = ee[QC] = ee[ZC] = ee[JC] = ee[eR] = ee[tR] = ee[rR] = ee[nR] = ee[iR] = !1;
    ...
    var hg = c(($H, gg) => {
        ...
        function rN(e, t, r, n, i, o) {
            ...
            if (y && !b) {
                var w = e.constructor,
                    R = t.constructor;
                w != R && "constructor" in e && "constructor" in t && !(typeof w == "function" && w instanceof w && typeof R == "function" && R instanceof R) && (y = !1)
            }
    ...
    var Nn = c((tk, Cg) => {
        var Yo = Eg(),
            ...
            _N = Ut(Jo),
            mt = wg;
        (Yo && mt(new Yo(new ArrayBuffer(1))) != xg || $o && mt(new $o) != bg || Qo && mt(Qo.resolve()) != Og || Zo && mt(new Zo) != Ag || Jo && mt(new Jo) != Sg) && (mt = function(e) {
            var t = wg(e),
    ...
    var Dg = c((rk, Mg) => {
        ...
        function xN(e, t, r, n, i, o) {
            ...
            if (d && !g) return o || (o = new ea), a || ON(e) ? TN(e, t, r, n, i, o) : IN(e, t, u, r, n, i, o);
            if (!(r & AN)) {
    ...
    var ft = c((Ck, Nh) => {
        ...
        function uq(e) {
            return typeof e == "function" ? e : e == null ? oq : typeof e == "object" ? aq(e) ? iq(e[0], e[1]) : nq(e) : sq(e)
        }
        Nh.exports = uq
    });
    var sa = c((Rk, Lh) => {
    ...
    var Yh, Ge, Gn, Vq, fa, dt, Kh, Vn, Bn = re(() => {
        "use strict";
        Yh = $(la()), Ge = typeof window < "u", Gn = (e, t) => Ge ? e() : t, Vq = Gn(() => (0, Yh.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], e => e in Element.prototype)), fa = Gn(() => {
            ...
            return "transform"
        }, "transform"), Kh = dt.split("transform")[0], Vn = Kh ? Kh + "TransformStyle" : "transformStyle"
    });
    var da = c((Vk, tv) => {
        var Bq = 4,
            Uq = .001,
        ...
        function Wq(e, t, r, n, i) {
            var o, a, s = 0;
            do a = t + (r - t) / 2, o = Xn(a, n, i) - e, o > 0 ? r = a : t = a; while (Math.abs(o) > Xq && ++s < Hq);
            return a
        }
    ...
    var Rr, Je, zq, Kq, Yq, $q, pa = re(() => {
        "use strict";
        Rr = $(da()), Je = 1.70158, zq = (0, Rr.default)(.25, .1, .25, 1), Kq = (0, Rr.default)(.42, 0, 1, 1), Yq = (0, Rr.default)(0, 0, .58, 1), $q = (0, Rr.default)(.42, 0, .58, 1)
    });
    var nv = {};
    Ie(nv, {
        applyEasing: () => NP,
    ...
    function ov(e, t, r, n, i) {
        let o = r === LP ? (0, Ht.getIn)(i, ["config", "target", "objectId"]) : null;
    ...
    var Ht, Uk, LP, Xk, qP, PP, FP, MP, DP, GP, VP, BP, UP, XP, HP, iv, kP, WP, jP, sv = re(() => {
        "use strict";
        Ht = $(Pt());
        Oe();
        ({
            ...
            switch (t.type) {
                ...
                case XP: {
                    ...
                    return (0, Ht.getIn)(u, [r, n]) !== n && (u = ov(u, n, a, r, o)), ha(u, r, s, i, o)
                }
                case HP: {
                    let {
                        elementId: r,
        ...
        function fF(e) {
            ...
            if (s.startsWith("#")) {
                ...
                let d = (1 - Math.abs(2 * p - 1)) * g,
                    ...
                    O = p - d / 2,
                    y, b, v;
                f >= 0 && f < 60 ? (y = d, b = m, v = 0) : f >= 60 && f < 120 ? (y = m, b = d, v = 0) : f >= 120 && f < 180 ? (y = 0, b = d, v = m) : f >= 180 && f < 240 ? (y = 0, b = m, v = d) : f >= 240 && f < 300 ? (y = m, b = 0, v = d) : (y = d, b = 0, v = m), t = Math.round((y + O) * 255), r = Math.round((b + O) * 255), n = Math.round((v + O) * 255)
    ...
    var dv = c(de => {
        ...
        var hF = (e, t) => {
            ...
            if (r.red != null && r.green != null && r.blue != null) return (0, dF.normalizeColor)(i)
        };
    ...
    var pv = c(Hn => {
        ...
        var ya = (Oe(), Ue(mf)),
            ...
            zk = Hn.pluginMethodMap = new Map([
                [ya.ActionTypeConsts.PLUGIN_LOTTIE, {
                    ..._F
                }],
                [ya.ActionTypeConsts.PLUGIN_SPLINE, {
                    ...TF
                }],
                [ya.ActionTypeConsts.PLUGIN_VARIABLE, {
                    ...IF
                }]
            ])
    });
    ...
    var _a, Tt, Ta, Ia, bF, ba, OF, Oa, Aa, Sa = re(() => {
        "use strict";
        Bn();
        _a = $(pv());
        Tt = e => t => {
            ...
            return n
        }, Ta = Tt("getPluginConfig"), Ia = Tt("getPluginOrigin"), bF = Tt("getPluginDuration"), ba = Tt("getPluginDestination"), OF = Tt("createPluginInstance"), Oa = Tt("renderPlugin"), Aa = Tt("clearPlugin")
    });
    var vv = c(($k, hv) => {
        function AF(e, t) {
    ...
    var Lv = c((oW, Nv) => {
        ...
        function $F(e, t, r) {
            ...
            if (!n) return -1;
            var i = n - 1;
            return r !== void 0 && (i = zF(r), i = r < 0 ? KF(n + i, 0) : YF(i, n - 1)), WF(e, jF(t, 3), i, !0)
        }
        Nv.exports = $F
    });
    var Pv = c((aW, qv) => {
    ...
    function Pa({
        ...
        if (Array.isArray(o) && o.length > 0) return o.reduce((L, _) => L.concat(Pa({
            config: {
                target: _
            },
            event: t,
        ...
        let x = (t?.action?.config?.affectedElements ?? {})[y || v] || {},
            F = !!(x.id || x.selector),
            M, G, U, k = t && s(Vv(t.target));
        if (F ? (M = x.limitAffectedElements, G = k, U = s(x)) : G = U = s({
                id: y,
                selector: v,
                selectorGuids: S
            }), t && w) {
        ...
        return G == null || U == null ? [] : Ge && n ? u(U).filter(L => n.contains(L)) : M === Dv ? u(G, U) : M === pM ? f(u(G)).filter(p(U)) : M === Gv ? g(u(G)).filter(p(U)) : u(U)
    }
    ...
    function wM(e, t = {}, r = {}, n, i) {
        ...
        switch (n.actionTypeId) {
            ...
            case zv:
                return {
                    value: (0, et.default)(parseFloat(o(e, jn)), 1)
                };
            case Kt: {
                let s = o(e, ze),
                    u = o(e, Ke),
                    f, g;
                return n.config.widthUnit === pt ? f = Bv.test(s) ? parseFloat(s) : parseFloat(r.width) : f = (0, et.default)(parseFloat(s), parseFloat(r.width)), n.config.heightUnit === pt ? g = Bv.test(u) ? parseFloat(u) : parseFloat(r.height) : g = (0, et.default)(parseFloat(u), parseFloat(r.height)), {
                    widthValue: f,
                    heightValue: g
                }
            }
            ...
            case $n:
                return {
                    value: (0, et.default)(o(e, zn), r.display)
                };
            case vM:
        ...
        switch (t.actionTypeId) {
            ...
            case Qt: {
                ...
                if (s && s.startsWith("--")) {
                    let {
                        getStyle: u
                    } = r, f = u(e, s), g = (0, Hv.normalizeColor)(f);
                    return {
                        rValue: g.red,
                        gValue: g.green,
                        bValue: g.blue,
    ...
    function KM(e, t, r, n, i, o) {
        ...
        switch (n.actionTypeId) {
            case Kt: {
                ...
                f !== void 0 && (s === pt && (s = "px"), It(e, ze, o), a(e, ze, f + s)), g !== void 0 && (u === pt && (u = "px"), It(e, Ke, o), a(e, Ke, g + u));
                break
            }
            case Dr: {
                BM(e, r, n.config, o);
            ...
            case Qt: {
                let s = qa[n.actionTypeId],
                    ...
                    p = r.aValue;
                It(e, s, o), a(e, s, p >= 1 ? `rgb(${u},${f},${g})` : `rgba(${u},${f},${g},${p})`);
                break
            }
            default: {
                let {
    ...
    function Qv(e, t, r) {
        ...
        !a || a.indexOf(n) === -1 || o(e, kt, a.split(Fr).map(Kv).filter(s => s !== n).join(Fr))
    }
    ...
    var et, Kn, Wn, Yn, Hv, tM, rM, nM, iM, oM, aM, sM, uM, cM, lM, jn, qr, Pr, ze, Ke, kv, fM, dM, Dv, pM, Gv, gM, zn, kt, pt, Fr, hM, Ra, Wv, Na, La, jv, Wt, jt, zt, Mr, zv, Dr, Gr, Kt, Yt, $t, Qt, $n, vM, Kv, qa, Yv, kn, yM, _M, bM, Bv, SM, xM, CM, RM, NM, Fa, FM, MM, DM, GM, HM, kM, WM, Zv, tE = re(() => {
        "use strict";
        ...
        ({
            ...
            GENERAL_DISPLAY: $n,
            OBJECT_VALUE: vM
        } = be, Kv = e => e.trim(), qa = Object.freeze({
            [Yt]: kv,
            [$t]: fM,
            [Qt]: dM
        }), Yv = Object.freeze({
    ...
    var Zn, tt, dD, pD, gD, hD, vD, ED, Qn, rE, yD, mD, Ma, _D, TD, ID, bD, nE, iE = re(() => {
        "use strict";
        Oe();
        Zn = $(bt()), tt = $(Pt()), {
            ...
            let {
                ...
                parameters: d
            } = t.payload, m = Math.max(1 - a, .01), O = d[n];
            O == null && (m = 1, O = s);
            ...
            p != null && (b = p), v = d ?? v, a === mD ? b = 0 : (o || O) && (b = v = 0);
            let {
                now: S
            } = t.payload;
            if (r && n) {
                ...
                let w = Qn(Math.min(Math.max(0, I / b), 1)),
                    ...
                    x = {},
                    F = null;
                return g.length && (F = g.reduce((M, G) => {
                    let U = f[G],
                        k = parseFloat(n[G]) || 0,
                        _ = (parseFloat(U) - k) * R + k;
                    return M[G] = _, M
                }, {})), x.current = F, x.position = w, w === 1 && (x.active = !1, x.complete = !0), (0, tt.merge)(e, x)
            }
            return e
            ...
            switch (t.type) {
                ...
                case gD: {
                    let {
                        ...
                        actionTypeId: G
                    } = i, U = _D(G), k = TD(U, G), L = Object.keys(d).filter(N => d[N] != null && typeof d[N] != "string"), {
                        easing: _
                    } = i.config;
                    return (0, tt.set)(e, r, {
                        id: r,
                        ...
                        skipMotion: F,
                        skipToValue: M,
                        customEasingFn: Array.isArray(_) && _.length === 4 ? yD(_) : void 0
                    })
                }
                case hD: {
                    let {
    ...
    var ME = c((LW, FE) => {
        ...
        function O1(e, t, r) {
            var n = e[t];
            (!(b1.call(e, t) && T1(n, r)) || r === void 0 && !(t in e)) && _1(e, t, r)
        }
        FE.exports = O1
    });
    var VE = c((qW, GE) => {
        ...
        function C1(e, t, r, n) {
            ...
            for (var i = -1, o = t.length, a = o - 1, s = e; s != null && ++i < o;) {
                ...
                if (i != a) {
                    var g = s[u];
                    f = n ? n(g, u, s) : void 0, f === void 0 && (f = DE(g) ? g : x1(t[i + 1]) ? [] : {})
                }
                A1(s, u, f), s = s[u]
            }
            return e
    ...
    var ny = c((XW, ry) => {
        ...
        function I2(e) {
            if (e == null) return !0;
            if (g2(e) && (p2(e) || typeof e == "string" || typeof e.splice == "function" || h2(e) || E2(e) || d2(e))) return !e.length;
            var t = f2(e);
    ...
    var vy = c((KW, hy) => {
        ...
        function U2(e, t, r) {
            ...
            t = gy(t) || 0, D2(r) && (g = !!r.leading, p = "maxWait" in r, o = p ? V2(gy(r.maxWait) || 0, t) : o, d = "trailing" in r ? !!r.trailing : d);
    ...
    var my, j2, z2, K2, Y2, $2, Q2, Z2, J2, eG, tG, rG, nG, iG, oG, aG, sG, uG, cG, lG, fG, dG, Xa, Ha, ka, Wa, pG, gG, hG, vG, Jn, EG, ja, ei, Jt, za, ti, Ka, Ya, er, $a, Qa, ri = re(() => {
        "use strict";
        Oe();
        my = $(bt()), {
    ...
    var Iy, Za, Ty, yG, mG, by, Vr, Oy = re(() => {
        "use strict";
        Iy = $(bt());
        Oe();
        ({
    ...
    var Fy = c((rj, Py) => {
        ...
        function qy(e, t, r, n, i) {
            ...
            for (r || (r = GG), i || (i = []); ++o < a;) {
                var s = e[o];
                t > 0 && r(s) ? t > 1 ? qy(s, t - 1, r, n, i) : DG(i, s) : n || (i[i.length] = s)
            }
            return i
        }
        Py.exports = qy
        ...
        function UV(e) {
            return qV(function(t) {
                ...
                for (n = a ? n : r; ++n < r;) {
                    ...
                    u && Im(u[0]) && u[1] == (VV | DV | GV | BV) && !u[4].length && u[9] == 1 ? a = a[os(u[0])].apply(a, u[3]) : a = o.length == 1 && Im(o) ? a[s]() : a.thru(o)
                }
                return function() {
                    var f = arguments,
                        g = f[0];
    ...
    var Vm, Bm, Um, Xm, zV, KV, YV, $V, QV, ZV, JV, e5, t5, r5, n5, i5, o5, a5, s5, Hm, km, u5, c5, l5, Wm, f5, d5, jm, p5, ss, zm, Nm, Lm, Km, Ur, g5, Ye, Ym, h5, Se, Ve, Xr, $m, us, qm, cs, v5, Br, E5, y5, m5, Qm, Pm, _5, Fm, T5, I5, b5, Mm, ci, li, Dm, Gm, Zm, Jm = re(() => {
        "use strict";
        Vm = $(Sm()), Bm = $(Fn()), Um = $(Rm());
        Oe();
        ls();
        ...
        Xm = $(bt()), {
            ...
            PAGE_START: jm,
            PAGE_SCROLL: p5
        } = De, ss = "COMPONENT_ACTIVE", zm = "COMPONENT_INACTIVE", {
            COLON_DELIMITER: Nm
        } = pe, {
            getNamespacedParameterId: Lm
        } = Xm.IX2VanillaUtils, Km = e => t => typeof t == "object" && e(t) ? !0 : t, Ur = Km(({
            element: e,
            nativeEvent: t
        }) => e === t.target), g5 = Km(({
            element: e,
            nativeEvent: t
        }) => e.contains(t.target)), Ye = (0, Vm.default)([Ur, g5]), Ym = (e, t) => {
            if (t) {
                let {
                    ixData: r
                } = e.getState(), {
            ...
            let {
                type: n
            } = t.nativeEvent, i = [ss, zm].indexOf(n) !== -1 ? n === ss : r.isActive, o = {
                ...r,
                isActive: i
            };
            ...
            let m = (g ? u : o * (u || 0) / 100) / p,
                O, y, b = 0;
            r && (O = d > r.percentTop, y = r.scrollingDown !== O, b = y ? d : r.anchorTop);
            ...
            ...$m,
            handler: Ve(e ? Ye : Ur, Qm((t, r) => r.isActive ? Xr.handler(t, r) : r))
        }), li = (e = !0) => ({
            ...$m,
            handler: Ve(e ? Ye : Ur, Qm((t, r) => r.isActive ? r : Xr.handler(t, r)))
        }), Dm = {
            ...cs,
            handler: _5((e, t) => {
                let {
                ...
                return !a[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === km === r ? (Se(e), {
                    ...t,
                    triggered: !0
                }) : t
            })
            ...
            [s5]: {
                ...
                handler: ({
                    ...
                    let {
                        ...
                        pageX: m = o.pageX,
                        pageY: O = o.pageY
                    } = n, y = s === "X_AXIS", b = n.type === "mouseout", v = g / 100, S = u, I = !1;
                    switch (a) {
                        case We.VIEWPORT: {
                            v = y ? Math.min(p, window.innerWidth) / window.innerWidth : Math.min(d, window.innerHeight) / window.innerHeight;
                            break
                        }
                        case We.PAGE: {
                            let {
                    ...
                    return b && (v > 1 - Gm || v < Gm) && (v = Math.round(v)), (a !== We.ELEMENT || I || I !== o.elementHovered) && (v = f ? 1 - v : v, e.dispatch(Jt(S, v))), {
                        elementHovered: I,
                        clientX: p,
                        clientY: d,
                        pageX: m,
            ...
            [l5]: {
                ...
                handler: ({
                    ...
                    if (g === We.VIEWPORT) {
                        ...
                        return _ !== i.scrollPercent && t.dispatch(Jt(w, _)), {
                            scrollPercent: _
                        }
                    }
                }
    ...
    function Q5(e, t) {
        let r = n => {
            ...
            i.active && (e.dispatch(ei(n, o)), t ? W5(e, r) : requestAnimationFrame(r))
        };
    ...
    function sB({
        ...
        (0, rr.default)(s, (p, d) => {
            ...
            G5(b, o.mediaQueryKeys) || t.dispatch(Qa()), O.actionTypeId === be.GENERAL_CONTINUOUS_ACTION && (Array.isArray(m.config) ? m.config : [m.config]).forEach(I => {
                let {
                    continuousParameterGroupId: w
                } = I, R = (0, rt.default)(a, `${v}.continuousParameterGroups`, []), x = (0, r_.default)(R, ({
                    id: G
            ...
            }), (O.actionTypeId === be.GENERAL_START_ACTION || fs(O.actionTypeId)) && d_({
                store: t,
                actionListId: v,
                eventId: y
            })
        ...
        let u = p => {
                ...
                oB(s, (m, O, y) => {
                    ...
                    S.actionTypeId === be.GENERAL_CONTINUOUS_ACTION ? (Array.isArray(b.config) ? b.config : [b.config]).forEach(w) : w()
                })
            },
            f = (0, s_.default)(u, X5),
            g = ({
    ...
    function tr({
        ...
        (0, rr.default)(o, u => {
            ...
            if (u.actionListId === i && u.eventId === t && g) {
                ...
                vs(u, e), u.verbose && e.dispatch(er({
                    actionListId: i,
                    isPlaying: !1
                }))
            }
    ...
    function Hr({
        ...
        } = p, m = (0, rt.default)(u, `actionLists.${i}`, {}), {
            actionItemGroups: O,
            useFirstGroupAsInitialState: y
        } = m;
        if (!O || !O.length) return !1;
        o >= O.length && (0, rt.default)(p, "config.loop") && (o = 0), o === 0 && y && o++;
        let v = (o === 0 || o === 1 && y) && fs(p.action?.actionTypeId) ? p.config.delay : void 0,
    ...
    function hs(e) {
        let {
            ...
            refState: v
        } = m[b] || {}, S = ts(i), I = O.reducedMotion && Fo[o.actionTypeId], w;
    ...
    var r_, rt, n_, i_, o_, a_, rr, s_, fi, O5, fs, ds, di, u_, A5, e_, pi, S5, ps, Ot, x5, w5, c_, C5, R5, N5, L5, q5, P5, gi, F5, M5, D5, G5, V5, hi, gs, B5, t_, U5, X5, rB, iB, oB, aB, ls = re(() => {
        "use strict";
        r_ = $(la()), rt = $(Fn()), n_ = $(CE()), i_ = $(ty()), o_ = $(ny()), a_ = $(oy()), rr = $(fy()), s_ = $(yy());
        Oe();
        fi = $(bt());
        ri();
        Oy();
        Jm();
        O5 = Object.keys(pn), fs = e => O5.includes(e), {
            COLON_DELIMITER: ds,
        ...
        } = fi.IX2VanillaPlugins, t_ = navigator.userAgent, U5 = t_.match(/iPad/i) || t_.match(/iPhone/), X5 = 12;
    ...
    var O_ = c((Pj, b_) => {
        "use strict";
        var nr = $e();
        nr.define("links", b_.exports = function(e, t) {
            var r = {},
                n = e(window),
                i, o = nr.env(),
                a = window.location,
            ...
            function O(v) {
                if (!v.getAttribute("hreflang")) {
                    ...
                    if (s.href = S, !(S.indexOf(":") >= 0)) {
                        ...
                        if (!(S === "#" || S === "")) {
                            var R = s.href === a.href || S === d || f.test(S) && g.test(d);
                            b(I, u, R)
                        }
                    }
                }
    ...
    var S_ = c((Fj, A_) => {
        "use strict";
        var yi = $e();
        yi.define("scroll", A_.exports = function(e) {
            var t = {
            ...
            function R(L) {
                if (r.hash !== L && n && n.pushState && !(yi.env.chrome && r.protocol === "file:")) {
            ...
            function x(L, _) {
                ...
                if (N !== D) {
                    var P = M(L, N, D),
                        ...
                        H = function() {
                            var J = Date.now() - W;
                            window.scroll(0, G(N, D, J, P)), J <= P ? s(H) : typeof _ == "function" && _()
                        };
                    s(H)
                }
            }
            ...
            function M(L, _, N) {
                if (S()) return 0;
                var D = 1;
                return a.add(L).each(function(P, W) {
            ...
            function k() {
                ...
                o.on(_, p, w), o.on(L, g, function(N) {
                    N.preventDefault()
        ...
        EB.define("touch", x_.exports = function(e) {
            ...
            function n(o) {
                var a = !1,
                    ...
                    f, g;
                o.addEventListener("touchstart", p, !1), o.addEventListener("touchmove", d, !1), o.addEventListener("touchend", m, !1), o.addEventListener("touchcancel", O, !1), o.addEventListener("mousedown", p, !1), o.addEventListener("mousemove", d, !1), o.addEventListener("mouseup", m, !1), o.addEventListener("mouseout", O, !1);

                function p(b) {
                    var v = b.touches;
                    v && v.length > 1 || (a = !0, v ? (s = !0, f = v[0].clientX) : f = b.clientX, g = f)
                }
                ...
                function y() {
                    o.removeEventListener("touchstart", p, !1), o.removeEventListener("touchmove", d, !1), o.removeEventListener("touchend", m, !1), o.removeEventListener("touchcancel", O, !1), o.removeEventListener("mousedown", p, !1), o.removeEventListener("mousemove", d, !1), o.removeEventListener("mouseup", m, !1), o.removeEventListener("mouseout", O, !1), o = null
                }
                this.destroy = y
            }
...
Webflow.require('ix2').init({
    "events": {
        "e-11": {
            ...
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51d8c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51d8b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51db7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51de3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-37": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51db9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-39": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51e8b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-41": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51e95",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-43": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1cc98eb9-c211-0ed7-454f-979346d51e9f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-69": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|1bbdc7c9-2226-27ed-a760-96f5cd7833d5",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-71": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|90c8939f-7af7-f6eb-0a57-a6f48ce1cc36",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-202": {
            ...
            "target": {
                "selector": ".s-scroll",
                "originalId": "66714fca43a137a8479d85b1|965e925f-3a0b-a7a8-8172-d03d1950a3a9",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".s-scroll",
        ...
        "e-204": {
            ...
            "target": {
                "selector": ".btn",
                "originalId": "66714fca43a137a8479d85b1|965e925f-3a0b-a7a8-8172-d03d1950a3b3",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".btn",
        ...
        "e-208": {
            ...
            "target": {
                ...
                "originalId": "61d726014a4fdd05f6382ed3|1511bf1a-c884-944b-f323-a3f0ea7187b6",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".trusted-item-header",
        ...
        "e-217": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|33c54073-b2de-ef46-a454-ebf888bbd4f6",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-219": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|aac82b25-4f89-cd45-f41b-fa501f5c08a9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-221": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|008b36aa-744d-df3c-2169-539edf083237",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-223": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|e2db88f4-7709-379d-9ee2-402d5b5e300f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-227": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|fc1cfa90-88e2-f8d6-6879-474c81929722",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-229": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|33c54073-b2de-ef46-a454-ebf888bbd4f5",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-235": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|3306c3aa-7ce8-1dfe-9ce2-f222ef48c7c7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-239": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|c3a8b6c5-645b-216f-0d0e-078cf8fbe9fe",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-241": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|da9e7fce-7a19-030c-3138-b4f47678f653",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-247": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|3895b35c-505c-2d38-1530-aadc3f963601",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-253": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|4d561a74-1d3a-a799-4d96-9827ab7d4391",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-257": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|4d561a74-1d3a-a799-4d96-9827ab7d4374",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-259": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "66714fca43a137a8479d85b1|ed770e6f-46c0-3210-9f38-49083e45b806",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-267": {
            ...
            "createdOn": 1719920022908
        }
    },
    "actionLists": {
        "a-17": {
            "id": "a-17",
            "title": "img-transition-in",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-17-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".img-transition-wrapper",
                            "selectorGuids": ["79c0f0f4-22a8-25c3-50d8-b95543ed44bd"]
                        },
                        "xValue": 0,
                        "yValue": null,
                        "xUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".lines-inner-wrapper",
                            "selectorGuids": ["79c0f0f4-22a8-25c3-50d8-b95543ed44bc"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["79c0f0f4-22a8-25c3-50d8-b95543ed44c9"]
                        },
                        "xValue": 10,
                        "xUnit": "deg",
                        "yUnit": "DEG",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["ed435a5c-2836-1b0d-87bf-2efabc8a286a"]
                        },
                        "yValue": 35,
                        "xUnit": "PX",
                        "yUnit": "%",
            ...
            "createdOn": 1617189216010
        },
        "a-18": {
            "id": "a-18",
            "title": "img-transition-out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-18-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["79c0f0f4-22a8-25c3-50d8-b95543ed44c5"]
                        },
                        "yValue": 35,
                        "xUnit": "PX",
                        "yUnit": "%",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "66714fca43a137a8479d85b1|965e925f-3a0b-a7a8-8172-d03d1950a3b3"
                        },
                        "filters": [{
                            "type": "brightness",
                            "filterId": "49f8",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "61d726014a4fdd05f6382ed3|e74ed22c-3155-00fa-e7e3-df8b5875d506"
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".output-slider_list",
                            "selectorGuids": ["59497155-3d0f-a8f4-bb56-d30644749caa"]
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "%",
